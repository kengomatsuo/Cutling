...
let appGroupID = "group.com.matsuokengo.Tine"
...
class SnippetStore: ObservableObject {
    ...
    private func setupDarwinNotification() {
        let notificationName = "com.matsuokengo.Tine.snippetsChanged" as CFString
    ...
    func save() {
        ...
        CFNotificationCenterPostNotification(
            CFNotificationCenterGetDarwinNotifyCenter(),
            CFNotificationName("com.matsuokengo.Tine.snippetsChanged" as CFString),
            nil,
            nil,
            true
        )
